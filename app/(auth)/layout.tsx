  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div
        ...
        style={{ background: "linear-gradient(135deg, #080f06 0%, #112009 50%, #0a1a07 100%)" }}
      >
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <span className="text-2xl font-bold tracking-tight" style={{ color: "#4ade80" }}>
            VYUM
          </span>
        </div>
        ...
        <div className="relative z-10 space-y-8">
          <div className="space-y-4">
            <h1 className="text-5xl font-bold leading-tight text-white">
              Compress smarter.
              <br />
              <span style={{ color: "#4ade80" }}>Share faster.</span>
            </h1>
            <p className="text-base leading-relaxed" style={{ color: "rgba(187,240,166,0.55)" }}>
          ...
          <ul className="space-y-3">
            {[
              ...
              <li key={feature} className="flex items-center gap-3">
                ...
                <span className="text-sm" style={{ color: "rgba(187,240,166,0.75)" }}>
                  {feature}
                </span>
              </li>
            ))}
        ...
        {/* Footer credit */}
        <p className="relative z-10 text-xs" style={{ color: "rgba(74,222,128,0.25)" }}>
          © 2026 VYUM
        </p>
      </div>
